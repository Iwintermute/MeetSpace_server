...
namespace {
    ...
    const std::unordered_set<std::string>& allowedServerEnvKeys() {
        static const std::unordered_set<std::string> keys = {
            ...
            "MEDIASOUP_PHYSICAL_CORE_COUNT",
            "MEDIASOUP_WS_MAX_PAYLOAD_BYTES",
            "MEDIASOUP_WS_MAX_PENDING_MESSAGES_PER_SOCKET",
            "MEDIASOUP_WS_MAX_CONNECTIONS",
            "MEDIASOUP_WS_OPERATION_TIMEOUT_MS",
            "MEDIASOUP_WS_HEARTBEAT_INTERVAL_MS",
            "MEDIASOUP_WS_HEARTBEAT_TIMEOUT_MS",
            "MEDIASOUP_MAX_ROOMS",
            "MEDIASOUP_MAX_PEERS_PER_ROOM",
            "MEDIASOUP_MAX_TOTAL_PEERS",
            "MEDIASOUP_MAX_TRANSPORTS_PER_ROOM",
            "MEDIASOUP_MAX_TOTAL_TRANSPORTS",
            "MEDIASOUP_MAX_PRODUCERS_PER_ROOM",
            "MEDIASOUP_MAX_TOTAL_PRODUCERS",
            "MEDIASOUP_MAX_CONSUMERS_PER_ROOM",
            "MEDIASOUP_MAX_TOTAL_CONSUMERS",
            "MEDIASOUP_MAX_PEERS_PER_WORKER",
            "MEDIASOUP_MAX_STRING_FIELD_LENGTH",
            ...
            "MEDIASOUP_DRAIN_TIMEOUT_MS",
            "MEDIASOUP_ICE_SERVERS",
            "MEDIASOUP_MAX_AUDIT_ENTRIES",
            "MEDIASOUP_PEER_RATE_WINDOW_MS",
            "MEDIASOUP_PEER_MAX_OPS_PER_WINDOW",

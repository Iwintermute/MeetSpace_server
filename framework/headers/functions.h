...
public:
    ...
    void loading_rect(ImDrawList* draw_list, std::string_view id, const ImVec2& pos_min, const ImVec2& pos_max, float rounding, float alpha);

    void gradient(std::string_view name, bool active, ImVec4 col[3]);

    void log_notify(int type);
